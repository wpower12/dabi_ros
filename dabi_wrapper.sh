...
## | ------------------- configure the paths ------------------ |
# Path to the root of the shared development directory under git
DABIDEV_PATH="/home/$USER/Documents/dabi_ros"
...
MOUNTS=(
  # The only change made for the DABI ROS env, mounting this dir to the container. 
  "type=bind" "$DABIDEV_PATH" "/home/$USER/dabi_ros"
